...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_care_site
;
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_person
;
...
SELECT
    ...
    (COUNT(person_id) - COUNT(DISTINCT person_id) = 0) AS test_passed
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_death
;

-- -------------------------------------------------------------------
-- FK to daring-tracer-300615.mimiciv_full_cdm_april26.cdm_person.person_id
-- -------------------------------------------------------------------
...
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_person fk
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_observation_period
;
...
SELECT
    ...
    (COUNT(cdm.person_id) = 0)          AS test_passed -- FK source
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_observation_period cdm
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_person fk
        ON cdm.person_id = fk.person_id
WHERE
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_visit_occurrence
;
...
SELECT
    ...
    (COUNT(cdm.person_id) = 0)          AS test_passed -- FK source
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_visit_occurrence cdm
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_person fk
        ON cdm.person_id = fk.person_id
WHERE
...
-- -------------------------------------------------------------------
-- FK to daring-tracer-300615.mimiciv_full_cdm_april26.cdm_visit_occurrence.visit_occurrence_id
-- -------------------------------------------------------------------
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_visit_occurrence cdm
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_visit_occurrence fk
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_visit_detail
;
...
SELECT
    ...
    (COUNT(cdm.person_id) = 0)          AS test_passed -- FK source
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_visit_detail cdm
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_person fk
        ON cdm.person_id = fk.person_id
WHERE
...
-- -------------------------------------------------------------------
-- FK to daring-tracer-300615.mimiciv_full_cdm_april26.cdm_visit_detail.visit_detail_id
-- -------------------------------------------------------------------
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_visit_detail cdm
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_visit_detail fk
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_condition_occurrence
;
...
SELECT
    ...
    (COUNT(cdm.person_id) = 0)          AS test_passed -- FK source
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_condition_occurrence cdm
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_person fk
        ON cdm.person_id = fk.person_id
WHERE
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_procedure_occurrence
;
...
SELECT
    ...
    (COUNT(cdm.person_id) = 0)          AS test_passed -- FK source
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_procedure_occurrence cdm
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_person fk
        ON cdm.person_id = fk.person_id
WHERE
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_observation
;
...
SELECT
    ...
    (COUNT(cdm.person_id) = 0)          AS test_passed -- FK source
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_observation cdm
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_person fk
        ON cdm.person_id = fk.person_id
WHERE
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_measurement
;
...
SELECT
    ...
    (COUNT(cdm.person_id) = 0)          AS test_passed -- FK source
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_measurement cdm
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_person fk
        ON cdm.person_id = fk.person_id
WHERE
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_device_exposure
;
...
SELECT
    ...
    (COUNT(cdm.person_id) = 0)          AS test_passed -- FK source
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_device_exposure cdm
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_person fk
        ON cdm.person_id = fk.person_id
WHERE
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_drug_exposure
;
...
SELECT
    ...
    (COUNT(cdm.person_id) = 0)          AS test_passed -- FK source
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_drug_exposure cdm
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_person fk
        ON cdm.person_id = fk.person_id
WHERE
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_condition_era
;
...
SELECT
    ...
    (COUNT(cdm.person_id) = 0)          AS test_passed -- FK source
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_condition_era cdm
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_person fk
        ON cdm.person_id = fk.person_id
WHERE
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_drug_era
;
...
SELECT
    ...
    (COUNT(cdm.person_id) = 0)          AS test_passed -- FK source
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_drug_era cdm
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_person fk
        ON cdm.person_id = fk.person_id
WHERE
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_dose_era
;
...
SELECT
    ...
    (COUNT(cdm.person_id) = 0)          AS test_passed -- FK source
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_dose_era cdm
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_person fk
        ON cdm.person_id = fk.person_id
WHERE
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_specimen
;
...
SELECT
    ...
    (COUNT(cdm.person_id) = 0)          AS test_passed -- FK source
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_specimen cdm
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_person fk
        ON cdm.person_id = fk.person_id
WHERE
