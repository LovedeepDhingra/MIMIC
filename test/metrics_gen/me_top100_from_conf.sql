DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_care_site;
CREATE TABLE daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_care_site
(
...
INSERT INTO daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_care_site
SELECT
...
inner join daring-tracer-300615.mimiciv_full_cdm_april26.voc_concept vc
    on ev.place_of_service_concept_id = vc.concept_id
inner join daring-tracer-300615.mimiciv_full_metrics_april26.me_total tt
...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_provider;
CREATE TABLE daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_provider
(
    concept_field     STRING,
    category          STRING,
    source_value      STRING,
...
INSERT INTO daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_provider
SELECT
...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_person;
CREATE TABLE daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_person
(
    concept_field     STRING,
    category          STRING,
    source_value      STRING,
...
INSERT INTO daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_person
SELECT
    'gender_concept_id'     AS concept_field,
    'Mapped'              AS category,
    CAST(ev.gender_source_value AS STRING)  AS source_value,
...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_death;
CREATE TABLE daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_death
(
    concept_field     STRING,
    category          STRING,
    source_value      STRING,
...
INSERT INTO daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_death
SELECT
...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_observation_period;
CREATE TABLE daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_observation_period
(
    concept_field     STRING,
    category          STRING,
    source_value      STRING,
...
INSERT INTO daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_observation_period
SELECT
...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_payer_plan_period;
CREATE TABLE daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_payer_plan_period
(
    concept_field     STRING,
    category          STRING,
    source_value      STRING,
...
INSERT INTO daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_payer_plan_period
SELECT
...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_visit_occurrence;
CREATE TABLE daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_visit_occurrence
(
    concept_field     STRING,
    category          STRING,
    source_value      STRING,
...
INSERT INTO daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_visit_occurrence
SELECT
...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_visit_detail;
CREATE TABLE daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_visit_detail
(
    concept_field     STRING,
    category          STRING,
    source_value      STRING,
...
INSERT INTO daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_visit_detail
SELECT
...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_condition_occurrence;
CREATE TABLE daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_condition_occurrence
(
    concept_field     STRING,
    category          STRING,
    source_value      STRING,
...
INSERT INTO daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_condition_occurrence
SELECT
...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_procedure_occurrence;
CREATE TABLE daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_procedure_occurrence
(
    concept_field     STRING,
    category          STRING,
    source_value      STRING,
...
INSERT INTO daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_procedure_occurrence
SELECT
...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_observation;
CREATE TABLE daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_observation
(
    concept_field     STRING,
    category          STRING,
    source_value      STRING,
...
INSERT INTO daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_observation
SELECT
...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_measurement;
CREATE TABLE daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_measurement
(
    concept_field     STRING,
    category          STRING,
    source_value      STRING,
...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_device_exposure;
CREATE TABLE daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_device_exposure
(
    concept_field     STRING,
    category          STRING,
    source_value      STRING,
...
INSERT INTO daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_device_exposure
SELECT
...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_drug_exposure;
CREATE TABLE daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_drug_exposure
(
    concept_field     STRING,
    category          STRING,
    source_value      STRING,
...
INSERT INTO daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_drug_exposure
SELECT
...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_cost;
CREATE TABLE daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_cost
(
    concept_field     STRING,
    category          STRING,
    source_value      STRING,
...
INSERT INTO daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_cost
SELECT
...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_condition_era;
CREATE TABLE daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_condition_era
(
    concept_field     STRING,
    category          STRING,
    source_value      STRING,
...
INSERT INTO daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_condition_era
SELECT
    'condition_concept_id'     AS concept_field,
    'Mapped'              AS category,
...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_drug_era;
CREATE TABLE daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_drug_era
(
    concept_field     STRING,
    category          STRING,
    source_value      STRING,
...
INSERT INTO daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_drug_era
SELECT
    'drug_concept_id'     AS concept_field,
    'Mapped'              AS category,
...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_dose_era;
CREATE TABLE daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_dose_era
(
    concept_field     STRING,
    category          STRING,
    source_value      STRING,
...
INSERT INTO daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_dose_era
SELECT
    'drug_concept_id'     AS concept_field,
    'Mapped'              AS category,
    CAST(ev.drug_concept_id AS STRING)  AS source_value,
...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_specimen;
CREATE TABLE daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_specimen
(
    concept_field     STRING,
    category          STRING,
    source_value      STRING,
...
INSERT INTO daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_specimen
SELECT
...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_note;
CREATE TABLE daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_note
(
    concept_field     STRING,
    category          STRING,
    source_value      STRING,
...
INSERT INTO daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_note
SELECT
...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_note_nlp;
CREATE TABLE daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_note_nlp
(
    concept_field     STRING,
    category          STRING,
    source_value      STRING,
...
INSERT INTO daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_note_nlp
SELECT
...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_fact_relationship;
CREATE TABLE daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_fact_relationship
(
    concept_field     STRING,
    category          STRING,
    source_value      STRING,
...
INSERT INTO daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_fact_relationship
SELECT
...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_cohort_attribute;
CREATE TABLE daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_cohort_attribute
(
    concept_field     STRING,
    category          STRING,
    source_value      STRING,
...
INSERT INTO daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_cohort_attribute
SELECT
    'value_as_concept_id'     AS concept_field,
    'Mapped'              AS category,
...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_metadata;
CREATE TABLE daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_metadata
(
    concept_field     STRING,
    category          STRING,
    source_value      STRING,
...
INSERT INTO daring-tracer-300615.mimiciv_full_metrics_april26.me_top_cdm_metadata
SELECT
