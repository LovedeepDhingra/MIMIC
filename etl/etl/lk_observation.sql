...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_observation_clean AS
-- rule 1, insurance
SELECT
...
INSERT INTO daring-tracer-300615.mimiciv_full_cdm_april26.lk_observation_clean
SELECT
    src.subject_id                  AS subject_id,
    src.hadm_id                     AS hadm_id,
    ...
    src.trace_id                    AS trace_id
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.src_drgcodes src -- drg
INNER JOIN
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_obs_admissions_concept AS
SELECT DISTINCT
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_observation_clean src
LEFT JOIN
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_observation_mapped AS
SELECT
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_observation_clean src
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_obs_admissions_concept lc
