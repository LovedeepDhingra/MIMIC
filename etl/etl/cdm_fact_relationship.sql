...
INSERT INTO daring-tracer-300615.mimiciv_full_cdm_april26.cdm_fact_relationship
SELECT
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_specimen_mapped spec
INNER JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_organism_mapped org
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_organism_mapped org
INNER JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_ab_mapped ab
