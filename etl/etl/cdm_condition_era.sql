...
-- condition.
-- -------------------------------------------------------------------
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.tmp_target_condition
AS SELECT
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_condition_occurrence co
WHERE
    co.condition_concept_id != 0
;

CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.tmp_dates_un_condition
    AS SELECT
    ...
    FROM
        daring-tracer-300615.mimiciv_full_cdm_april26.tmp_target_condition
UNION ALL
    SELECT
        person_id                                             AS person_id,
        condition_concept_id                                  AS condition_concept_id,
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.tmp_dates_rows_condition
AS SELECT
    person_id                       AS person_id,
    condition_concept_id            AS condition_concept_id,
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.tmp_dates_un_condition
;

CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.tmp_enddates_condition
AS SELECT
    person_id                                       AS person_id,
    condition_concept_id                            AS condition_concept_id,
    DATE_SUB (event_date, INTERVAL 30 DAY)          AS end_date  -- unpad the end date
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.tmp_dates_rows_condition e
WHERE
    (2 * e.start_ordinal) - e.overall_ord = 0
;

CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.tmp_conditionends
AS SELECT
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.tmp_target_condition c
JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.tmp_enddates_condition e
...
-- -------------------------------------------------------------------
INSERT INTO daring-tracer-300615.mimiciv_full_cdm_april26.cdm_condition_era
SELECT
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.tmp_conditionends
GROUP BY
    person_id,
    condition_concept_id,
    era_end_date
...
-- -------------------------------------------------------------------
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_cdm_april26.tmp_conditionends;
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_cdm_april26.tmp_enddates_condition;
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_cdm_april26.tmp_dates_rows_condition;
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_cdm_april26.tmp_dates_un_condition;
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_cdm_april26.tmp_target_condition;
-- -------------------------------------------------------------------
-- Loading finished
-- -------------------------------------------------------------------
