...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_cdm_april26.lk_wf_clean;

CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_waveform_clean AS
SELECT
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.src_waveform_mx src -- wm
INNER JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.src_waveform_header wh
...
INSERT INTO daring-tracer-300615.mimiciv_full_cdm_april26.lk_waveform_clean
SELECT
    wh.subject_id                           AS subject_id,
    CONCAT(
        wh.reference_id, '.', 
    ...
    src.trace_id                            AS trace_id
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.src_waveform_mx_3 src -- wm
INNER JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.src_waveform_header_3 wh
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_wf_hadm_id AS
SELECT
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_waveform_clean src
INNER JOIN 
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_waveform_mapped AS
SELECT
...
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.voc_concept_relationship vr
...
LEFT JOIN 
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_wf_hadm_id hadm
