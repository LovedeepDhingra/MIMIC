...
-- Rule 1
-- -------------------------------------------------------------------
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_prescriptions_clean AS
SELECT
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.src_prescriptions src -- pr
LEFT JOIN 
    daring-tracer-300615.mimiciv_full_cdm_april26.src_pharmacy pharm
...
-- -------------------------------------------------------------------
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_pr_ndc_concept AS
SELECT DISTINCT
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_prescriptions_clean src -- pr
LEFT JOIN
...
-- Rule 1
-- -------------------------------------------------------------------
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_pr_gcpt_concept AS
SELECT DISTINCT
...
-- Rule 1
-- -------------------------------------------------------------------
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_pr_route_concept AS
SELECT DISTINCT
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_drug_mapped AS
SELECT
    src.hadm_id                                     AS hadm_id,
    src.subject_id                                  AS subject_id,
    ...
    src.trace_id                    AS trace_id
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_prescriptions_clean src
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_pr_ndc_concept vc_ndc
        ON  src.ndc_source_code = vc_ndc.source_code
        AND vc_ndc.target_concept_id IS NOT NULL
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_pr_gcpt_concept vc_gcpt
        ON  src.gcpt_source_code = vc_gcpt.source_code
        AND vc_gcpt.target_concept_id IS NOT NULL
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_pr_route_concept vc_route
