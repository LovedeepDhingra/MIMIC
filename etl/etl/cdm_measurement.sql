...
INSERT INTO daring-tracer-300615.mimiciv_full_cdm_april26.cdm_measurement
SELECT
...
FROM  
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_labevents_mapped src -- 107,209 
INNER JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_person per -- 110,849
        ON CAST(src.subject_id AS STRING) = per.person_source_value
INNER JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_visit_occurrence vis -- 116,559
...
INNER JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_person per 
        ON CAST(src.subject_id AS STRING) = per.person_source_value
INNER JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_visit_detail vd 
