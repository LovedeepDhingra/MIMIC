...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_chartevents_clean AS
SELECT
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.src_chartevents src -- ce
INNER JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.src_d_items di
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.tmp_chartevents_code_dist AS
...
SELECT
    ...
    COUNT(*)                    AS row_count
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_chartevents_clean
GROUP BY
    itemid,
    source_code,
    source_label
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_chartevents_concept AS
SELECT
    src.itemid                  AS itemid,
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.tmp_chartevents_code_dist src
LEFT JOIN
...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_cdm_april26.tmp_chartevents_code_dist;
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_chartevents_mapped AS
SELECT
    ...
    src.trace_id            AS trace_id
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_chartevents_clean src -- ce
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_chartevents_concept c_main -- main
        ON c_main.source_code = src.source_code 
        AND c_main.source_vocabulary_id = 'mimiciv_meas_chart'
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_chartevents_concept c_value -- values for main
...
LEFT JOIN 
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_unit_concept uc
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_chartevents_condition_mapped AS
SELECT
    src.subject_id                              AS subject_id,
    src.hadm_id                                 AS hadm_id,
    src.stay_id                                 AS stay_id,
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_chartevents_clean src -- ce
INNER JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_chartevents_concept c_main -- condition domain from values, mapped
