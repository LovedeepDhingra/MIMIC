...
--      see daring-tracer-300615.mimiciv_full_cdm_april26.an_labevents_full
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_d_labitems_clean AS
SELECT
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.src_d_labitems dlab
;
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_labevents_clean AS
SELECT
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.src_labevents src
INNER JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.src_d_labitems dlab
...
-- -------------------------------------------------------------------
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_d_labitems_concept AS
SELECT
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_d_labitems_clean dlab
LEFT JOIN
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_labevents_hadm_id AS
SELECT
...
FROM  
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_labevents_clean src
INNER JOIN 
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_labevents_mapped AS
SELECT
...
FROM  
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_labevents_clean src
INNER JOIN 
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_d_labitems_concept labc
        ON labc.itemid = src.itemid
LEFT JOIN 
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_operator_concept opc
...
LEFT JOIN 
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_labevents_hadm_id hadm
