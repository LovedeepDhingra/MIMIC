...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_diagnoses_icd_clean AS
SELECT
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.src_diagnoses_icd src
INNER JOIN
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_diagnoses_icd_mapped AS
SELECT
    src.subject_id                      AS subject_id,
    src.hadm_id                         AS hadm_id,
    ...
    src.trace_id            AS trace_id  
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_diagnoses_icd_clean src
LEFT JOIN
...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_cdm_april26.tmp_seq_num_to_concept;
