...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_operator_concept AS
SELECT
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.tmp_meas_unit AS
SELECT
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_unit_concept AS
SELECT
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.tmp_meas_unit vc
LEFT JOIN
...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_cdm_april26.tmp_meas_unit;
