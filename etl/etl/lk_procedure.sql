...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_cdm_april26.lk_datetimeevents_concept;
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_cdm_april26.lk_proc_event_clean;
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_cdm_april26.lk_datetimeevents_clean;
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_hcpcsevents_clean AS
 SELECT
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.src_hcpcsevents src
INNER JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.src_admissions adm
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_procedures_icd_clean AS
SELECT
    src.subject_id                              AS subject_id,
    src.hadm_id                                 AS hadm_id,
    adm.dischtime                               AS start_datetime,
    ...
    src.trace_id                        AS trace_id
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.src_procedures_icd src
INNER JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.src_admissions adm
        ON src.hadm_id = adm.hadm_id
;
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_proc_d_items_clean AS
SELECT
    src.subject_id                      AS subject_id,
    src.hadm_id                         AS hadm_id,
    ...
    src.trace_id                        AS trace_id
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.src_procedureevents src
WHERE
...
-- -------------------------------------------------------------------
INSERT INTO daring-tracer-300615.mimiciv_full_cdm_april26.lk_proc_d_items_clean
SELECT
    src.subject_id                      AS subject_id,
    src.hadm_id                         AS hadm_id,
    ...
    src.trace_id                        AS trace_id    
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.src_datetimeevents src -- de
INNER JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.src_patients pat
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_hcpcs_concept AS
SELECT
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_icd_proc_concept AS
SELECT
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_itemid_concept AS
SELECT
    ...
    vc2.concept_id                      AS target_concept_id
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.src_d_items d_items
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.voc_concept vc
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_procedure_mapped AS
SELECT
    ...
    src.trace_id                    AS trace_id
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_hcpcsevents_clean src
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_hcpcs_concept lc
        ON src.hcpcs_cd = lc.source_code
;

-- Rule 2, ICD

INSERT INTO daring-tracer-300615.mimiciv_full_cdm_april26.lk_procedure_mapped
SELECT
    src.subject_id                          AS subject_id, -- to person
    src.hadm_id                             AS hadm_id, -- to visit
    src.start_datetime                      AS start_datetime,
    ...
    src.trace_id                    AS trace_id
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_procedures_icd_clean src
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_icd_proc_concept lc
...
SELECT
    ...
    src.trace_id                    AS trace_id
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_proc_d_items_clean src
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_itemid_concept lc
