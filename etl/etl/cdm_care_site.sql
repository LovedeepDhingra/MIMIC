...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_trans_careunit_clean AS
SELECT
...
INSERT INTO daring-tracer-300615.mimiciv_full_cdm_april26.cdm_care_site
SELECT
...
FROM 
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_trans_careunit_clean src
LEFT JOIN
