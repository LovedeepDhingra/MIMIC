...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.tmp_subject_ethnicity AS
SELECT DISTINCT
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.src_admissions src
;
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_pat_ethnicity_concept AS
SELECT DISTINCT
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.tmp_subject_ethnicity src
LEFT JOIN
    -- gcpt_ethnicity_to_concept -> mimiciv_per_ethnicity
...
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.voc_concept_relationship cr1
        ON  cr1.concept_id_1 = vc.concept_id
        AND cr1.relationship_id = 'Maps to'
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.voc_concept vc1
...
FROM 
    daring-tracer-300615.mimiciv_full_cdm_april26.src_patients p
LEFT JOIN 
    daring-tracer-300615.mimiciv_full_cdm_april26.tmp_subject_ethnicity eth 
        ON  p.subject_id = eth.subject_id
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_pat_ethnicity_concept map_eth
...
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_cdm_april26.tmp_subject_ethnicity;
