...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_micro_cross_ref AS
SELECT
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.src_microbiologyevents src -- mbe
;
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_micro_hadm_id AS
SELECT
...
FROM  
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_micro_cross_ref src
INNER JOIN 
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_admissions_clean adm
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_organism_clean AS
SELECT DISTINCT
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.src_microbiologyevents src -- mbe
INNER JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_micro_cross_ref cr
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_specimen_clean AS
SELECT DISTINCT
    src.subject_id                              AS subject_id,
    src.hadm_id                                 AS hadm_id,
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_organism_clean src -- mbe
INNER JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_micro_cross_ref cr
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_ab_clean AS
SELECT
    src.subject_id                              AS subject_id,
    src.hadm_id                                 AS hadm_id,
    cr.start_datetime                           AS start_datetime,
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.src_microbiologyevents src
INNER JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_micro_cross_ref cr
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_d_micro_clean AS
SELECT
    dm.itemid                                       AS itemid,
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.src_d_micro dm
UNION ALL
SELECT DISTINCT
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_ab_clean src
WHERE
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_d_micro_concept AS
SELECT
    dm.itemid                   AS itemid,
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_d_micro_clean dm
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.voc_concept vc
...
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.voc_concept_relationship vcr
        ON  vc.concept_id = vcr.concept_id_1
        AND vcr.relationship_id = 'Maps to'
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.voc_concept vc2
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_specimen_mapped AS
SELECT
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_specimen_clean src
INNER JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_d_micro_concept mc
        ON src.spec_itemid = mc.itemid
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_micro_hadm_id hadm
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_organism_mapped AS
SELECT
    ...
    src.trace_id                    AS trace_id
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_organism_clean src
INNER JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_d_micro_concept tc
        ON src.test_itemid = tc.itemid
INNER JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_d_micro_concept sc
        ON src.spec_itemid = sc.itemid
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_d_micro_concept oc
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_ab_mapped AS
SELECT
    FARM_FINGERPRINT(GENERATE_UUID())           AS measurement_id,
    src.subject_id                              AS subject_id,
    COALESCE(src.hadm_id, hadm.hadm_id)         AS hadm_id,
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_ab_clean src
INNER JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_d_micro_concept ac
        ON src.ab_itemid = ac.itemid
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_d_micro_concept rc
        ON src.interpretation = rc.source_code
        AND rc.source_vocabulary_id = 'mimiciv_micro_resistance' -- new vocab
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_operator_concept opc -- see lk_meas_labevents.sql
