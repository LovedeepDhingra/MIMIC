...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_visit_no_hadm_all AS
-- labevents
SELECT
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_labevents_mapped src
WHERE
    src.hadm_id IS NULL
UNION ALL
-- specimen
SELECT
    ...
    src.trace_id                    AS trace_id
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_specimen_mapped src
WHERE
    src.hadm_id IS NULL
UNION ALL
-- organism
SELECT
    ...
    src.trace_id                    AS trace_id
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_organism_mapped src
WHERE
    src.hadm_id IS NULL
UNION ALL
-- antibiotics
SELECT
    ...
    src.trace_id                    AS trace_id
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_ab_mapped src
WHERE
    src.hadm_id IS NULL
UNION ALL
-- waveforms
SELECT
    ...
    src.trace_id                    AS trace_id
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_meas_waveform_mapped src
WHERE
    src.hadm_id IS NULL
;
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_visit_no_hadm_dist AS
SELECT
    src.subject_id                                  AS subject_id,
...
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_visit_no_hadm_all src
GROUP BY
    src.subject_id,
    src.date_id
;
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_visit_detail_waveform_dist AS
SELECT
    src.subject_id                                  AS subject_id,
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_visit_clean AS
SELECT
    ...
    src.trace_id                    AS trace_id
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_admissions_clean src -- adm
UNION ALL
SELECT
    FARM_FINGERPRINT(GENERATE_UUID())               AS visit_occurrence_id,
    src.subject_id                                  AS subject_id,
    ...
    src.trace_id                    AS trace_id
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_visit_no_hadm_dist src -- adm
;
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_visit_detail_clean AS
SELECT
    ...
    src.trace_id                    AS trace_id
FROM 
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_transfers_clean src
WHERE
...
-- ER admissions
-- -------------------------------------------------------------------
INSERT INTO daring-tracer-300615.mimiciv_full_cdm_april26.lk_visit_detail_clean
SELECT
    FARM_FINGERPRINT(GENERATE_UUID())               AS visit_detail_id,
    src.subject_id                                  AS subject_id,
    src.hadm_id                                     AS hadm_id,
    ...
    src.trace_id                    AS trace_id
FROM 
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_admissions_clean src
WHERE
    src.is_er_admission
;
...
SELECT
    ...
    src.trace_id                    AS trace_id
FROM 
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_services_clean src
WHERE
...
SELECT
    ...
    src.trace_id                    AS trace_id
FROM 
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_visit_detail_waveform_dist src
;
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_visit_detail_prev_next AS
SELECT 
    ...
    src.trace_id                      AS trace_id
FROM 
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_visit_detail_clean src
LEFT JOIN 
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_visit_clean vis
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_visit_concept AS
SELECT 
