...
INSERT INTO daring-tracer-300615.mimiciv_full_cdm_april26.cdm_procedure_occurrence
SELECT
...
SELECT
    ...
    src.trace_id                    AS trace_id
FROM
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_observation_mapped src
INNER JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.cdm_person per
        ON CAST(src.subject_id AS STRING) = per.person_source_value
INNER JOIN
