...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.cdm_dose_era
(
...
-- -------------------------------------------------------------------
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.tmp_drugIngredientExp AS
SELECT
...
FROM daring-tracer-300615.mimiciv_full_cdm_april26.cdm_drug_exposure de
INNER JOIN daring-tracer-300615.mimiciv_full_cdm_april26.voc_drug_strength ds
    ON de.drug_concept_id = ds.drug_concept_id
INNER JOIN daring-tracer-300615.mimiciv_full_cdm_april26.voc_concept_ancestor ca
    ON  de.drug_concept_id = ca.descendant_concept_id
    AND ds.ingredient_concept_id = ca.ancestor_concept_id
LEFT JOIN daring-tracer-300615.mimiciv_full_cdm_april26.voc_concept c
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.tmp_drugWithDose AS
SELECT
...
FROM daring-tracer-300615.mimiciv_full_cdm_april26.tmp_drugIngredientExp
;
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.tmp_cteDoseTarget AS
SELECT
...
FROM daring-tracer-300615.mimiciv_full_cdm_april26.tmp_drugWithDose dwd
WHERE
    dose_value <> -1
;
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.tmp_cteDoseEndDates_rawdata AS
SELECT
    person_id                                       AS person_id,
...
FROM daring-tracer-300615.mimiciv_full_cdm_april26.tmp_cteDoseTarget
UNION ALL
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.tmp_cteDoseEndDates_e AS
SELECT
    person_id                                                                   AS person_id,
    drug_concept_id                                                             AS drug_concept_id,
    unit_concept_id                                                             AS unit_concept_id,
...
FROM daring-tracer-300615.mimiciv_full_cdm_april26.tmp_cteDoseEndDates_rawdata
;
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.tmp_cteDoseEndDates AS
SELECT
    person_id                                       AS person_id,
    drug_concept_id                                 AS drug_concept_id,
    unit_concept_id                                 AS unit_concept_id,
...
FROM daring-tracer-300615.mimiciv_full_cdm_april26.tmp_cteDoseEndDates_e
WHERE
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.tmp_cteDoseFinalEnds AS
SELECT
...
FROM daring-tracer-300615.mimiciv_full_cdm_april26.tmp_cteDoseTarget dt
INNER JOIN daring-tracer-300615.mimiciv_full_cdm_april26.tmp_cteDoseEndDates e
...
INSERT INTO daring-tracer-300615.mimiciv_full_cdm_april26.cdm_dose_era
SELECT
...
FROM daring-tracer-300615.mimiciv_full_cdm_april26.tmp_cteDoseFinalEnds
GROUP BY
    person_id,
    drug_concept_id,
    unit_concept_id,
...
-- -------------------------------------------------------------------
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_cdm_april26.tmp_drugIngredientExp;
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_cdm_april26.tmp_drugWithDose;
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_cdm_april26.tmp_cteDoseTarget;
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_cdm_april26.tmp_cteDoseEndDates_rawdata;
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_cdm_april26.tmp_cteDoseEndDates_e;
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_cdm_april26.tmp_cteDoseEndDates;
DROP TABLE IF EXISTS daring-tracer-300615.mimiciv_full_cdm_april26.tmp_cteDoseFinalEnds;
