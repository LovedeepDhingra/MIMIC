...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_admissions_clean AS
SELECT
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_transfers_clean AS
SELECT
    src.subject_id                                  AS subject_id,
    ...
    src.trace_id                    AS trace_id
FROM 
    daring-tracer-300615.mimiciv_full_cdm_april26.src_transfers src
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_admissions_clean vis -- associate transfers with admissions according to 
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_services_duplicated AS
SELECT
    trace_id, COUNT(*) AS row_count
FROM 
    daring-tracer-300615.mimiciv_full_cdm_april26.src_services src
GROUP BY
    src.trace_id
HAVING COUNT(*) > 1
;
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.lk_services_clean AS
SELECT
    src.subject_id                                  AS subject_id,
    src.hadm_id                                     AS hadm_id,
...
FROM 
    daring-tracer-300615.mimiciv_full_cdm_april26.src_services src
LEFT JOIN
    daring-tracer-300615.mimiciv_full_cdm_april26.lk_services_duplicated sd
