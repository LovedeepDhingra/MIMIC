...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.src_diagnoses_icd AS
SELECT
...
FROM
    daring-tracer-300615.mimic4_data.diagnoses_icd
;
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.src_services AS
SELECT
    subject_id                          AS subject_id,
    hadm_id                             AS hadm_id,
...
FROM
    daring-tracer-300615.mimic4_data.services
;
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.src_labevents AS
SELECT
...
FROM
    daring-tracer-300615.mimic4_data.labevents
;
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.src_d_labitems AS
SELECT
    itemid                              AS itemid,
    label                               AS label,
    fluid                               AS fluid,
...
FROM
    daring-tracer-300615.mimic4_data.d_labitems
;
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.src_procedures_icd AS
SELECT
    subject_id                          AS subject_id,
    hadm_id                             AS hadm_id,
    icd_code        AS icd_code,
...
FROM
    daring-tracer-300615.mimic4_data.procedures_icd
;
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.src_hcpcsevents AS
SELECT
    hadm_id                             AS hadm_id,
    subject_id                          AS subject_id,
...
FROM
    daring-tracer-300615.mimic4_data.hcpcsevents
;
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.src_drgcodes AS
SELECT
    hadm_id                             AS hadm_id,
    subject_id                          AS subject_id,
...
FROM
    daring-tracer-300615.mimic4_data.drgcodes
;
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.src_prescriptions AS
SELECT
    hadm_id                             AS hadm_id,
    subject_id                          AS subject_id,
...
FROM
    daring-tracer-300615.mimic4_data.prescriptions
;
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.src_microbiologyevents AS
SELECT
...
FROM
    daring-tracer-300615.mimic4_data.microbiologyevents
;
...
-- CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.src_d_micro AS
-- SELECT
...
--     ))                                  AS trace_id
-- FROM
--     daring-tracer-300615.mimic4_data.d_micro
-- ;
...
CREATE OR REPLACE TABLE daring-tracer-300615.mimiciv_full_cdm_april26.src_pharmacy AS
SELECT
    pharmacy_id                         AS pharmacy_id,
...
FROM
    daring-tracer-300615.mimic4_data.pharmacy
;
